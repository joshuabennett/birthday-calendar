...
> {
  ...
  public render(): React.ReactElement<IHappyBirthdayCardProps> {
    console.log(this.props.birthday + "---" + this.props.anniversary);
    this._birthdayMsg = this.state.isBirthdayToday
      ? this.props.anniversary
        ? `${moment(this.props.anniversary)
            .set("year", 2022)
            .diff(this.props.anniversary, "years")} Year${
            moment(this.props.anniversary)
              .set("year", 2022)
              .diff(this.props.anniversary, "years") > 1
              ? "s"
              : ""
          } at Tarrytown!`
        ...
        <div className={styles.documentCardWrapper}>
          <div
            className={
              styles.documentCard +
              " " +
              (this.state.isBirthdayToday ? styles.todayBirthday : "")
            }
          >
            <Image
